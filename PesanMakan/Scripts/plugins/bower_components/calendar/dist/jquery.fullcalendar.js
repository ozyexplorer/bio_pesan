$(document).ready(function() {
    ...
    $(".add-event-btn").click(function (e) {
        if (!$(".add-event").val().length == 0) {
            $('<div class="calendar-event">' + $(".add-event").val() + '<a href="javascript:void(0);" class="remove-calendar-event"><i class="ti-close"></i></a></div>').insertBefore(".add-event");
            $(this).val('');
        } else {
